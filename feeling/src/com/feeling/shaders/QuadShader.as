package com.feeling.shaders
{
	...
	public class QuadShader
	{
		...
		public static function registerPrograms():void
		{
			...
			Feeling.instance.shaderManager.registerProgram( 
				PROGRAM_NAME, vertexProgramAssembler.agalcode, fragmentProgramAssembler.agalcode );
		}
	}
}